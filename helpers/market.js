module.exports = {
    checkFullBody: function (req, postType) {
        ...
        if (postType === "buy"){
            ...
            req.checkBody('buyPrice', 'sellPrice is required').isDecimal({decimal_digits: '1,2', min:1, max:99});
            ...
            req.checkBody('sellPrice', 'sellPrice is required').isDecimal({decimal_digits: '1,2',min:1, max:99});
        }
